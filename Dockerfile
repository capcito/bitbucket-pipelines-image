...
RUN apt-get update && apt-get install -qy curl libxml2-dev unzip gettext zip git libzip-dev default-mysql-client locales nodejs python3-pip libjpeg-dev libwebp-dev libpng-dev
